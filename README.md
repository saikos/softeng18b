...
3. Εκτελείτε `./gradlew test` για να τρέξετε τα integration tests. Δείτε την κλάση [RestAPISpecification](tree/master/src/test/gr/ntua/ece/softeng18b/RestAPISpecification.groovy), που περιέχει τον βασικό σκελετό των δοκιμών. 
